...
namespace Dio.Series
{
    class Program
    {
        ...
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Escolha '1' para acessar o catalogo de Séries ou '2' para o catálogo de Filmes");
			...
			Console.ReadLine();
                ...
                string opcaoUsuarioF = ObterOpcaoUsuarioFilmes();
				...
				opcaoUsuarioF = ObterOpcaoUsuarioFilmes();
			}
        ...
        foreach (int i in Enum.GetValues(typeof(Genero)))
			...
			Console.Write("Digite o Título do fime: ");
			string entradaTitulo = Console.ReadLine();
